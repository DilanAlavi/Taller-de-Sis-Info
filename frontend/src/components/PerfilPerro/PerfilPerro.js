...
//       try {
//         const response = await axios.get(`http://127.0.0.1:8000/perritos/${id}`);
...
//       <img src={`http://127.0.0.1:8000/imagen/${perro.foto[0].direccion_foto}`} alt={`Foto de ${perro.nombre}`} className="perfil-perro-imagen" />
