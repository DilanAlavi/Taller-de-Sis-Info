...
const ContactPage = () => {
  ...
  return (
    <div className="contact-page" style={{ padding: '20px' }}>
      ...
      <div>
        <h2>He encontrado a mi perro perdido. ¿Cómo elimino su perfil del sitio?</h2>
        <p>
      ...
      <div>
        <h2>Entregué un perro encontrado a sus dueños. ¿Cómo lo elimino de mi lista?</h2>
        <p>
      ...
      <div>
        <h2>El formulario de registro me pide una contraseña, ¿cómo obtengo una?</h2>
        <p>
      ...
      <div>
        <h2>¿Cómo se utiliza mi información de contacto?</h2>
        <p>
      ...
      <div>
        <h2>¿Cómo subo una foto de mi perro?</h2>
        <p>
