    ...
    <div className="fundraiser-page">
      ...
      <div className="fundraiser-section">
        ...
        <div className="qr-code-container">
          <img src="https://www.informatique-mania.com/wp-content/uploads/2021/02/codigo-qr.jpg" alt="Código QR para donar" className="qr-image" />
        </div>
      </div>
      ...
      <div className="fundraiser-section">
        ...
        <div className="share-buttons">
          <a href="https://www.facebook.com/p/jhulians-garcia-hinojosa-100001069936007/?mibextid=ZbWKwL" target="_blank" rel="noopener noreferrer" className="share-button share-button--facebook">Compartir en Facebook</a>
          <a href="https://wa.me/67559550" target="_blank" rel="noopener noreferrer" className="share-button share-button--whatsapp">Compartir en WhatsApp</a>
          <a href="https://www.instagram.com/jhuls_garcia?igsh=YjVibnQ0dnh5Zmlr" target="_blank" rel="noopener noreferrer" className="share-button share-button--instagram">Compartir en Instagram</a>
        </div>
      </div>
    </div>
  );
